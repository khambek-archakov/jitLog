...
//
//	mockgen -source=contract.go -destination=mock_start_test.go -package=start_test
//

// Package start_test is a generated GoMock package.
package start_test
...
func (m *Mockhandler) Handle(ctx context.Context, u *model.User, in dto.Input) error {
	m.ctrl.T.Helper()
...
func (mr *MockhandlerMockRecorder) Handle(ctx, u, in any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Handle", reflect.TypeOf((*Mockhandler)(nil).Handle), ctx, u, in)
}
